    ...
    { type: core_1.Component, args: [{
                ...
                animations: [
                    core_1.trigger('enterLeave', [
                        ...
                        core_1.state("fromTop", core_1.style({ opacity: 1, transform: "translateY(0)" })),
                        core_1.transition("* => fromTop", [
                            core_1.style({ opacity: 0, transform: "translateY(-100%)" }),
                            core_1.animate("400ms ease-in-out")
                        ]),
                        core_1.state("fromTopOut", core_1.style({ opacity: 0, transform: "translateY(-100%)" })),
                        core_1.transition("fromTop => fromTopOut", [
